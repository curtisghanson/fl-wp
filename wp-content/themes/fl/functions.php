<?php
/**
 * fairviewlodge functions and definitions.
 *
...
function fl_setup() {
	 ...
	 * If you're building a theme based on fairviewlodge, use a find and replace
	...
	register_nav_menus( array(
		'primary' => esc_html__( 'Primary Menu', 'fl' ),
	) );
